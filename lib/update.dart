...
class Update extends StatefulWidget {
  ...
  Update(this.database, this.title, this.content);
...
class _UpdateState extends State<Update> {
  ...
  // FontWeight bold_text = FontWeight.bold;
        ...
        actions: [
          IconButton(
              onPressed: () async {
                ...
                content = t2.text;
                String sql =
                    "update note_book set title='$title',content='$content' where title='${widget.title}'";
                print("sql= ${sql}");
                int qry = await widget.database!.rawUpdate(sql);
                print("qry = $qry");
                t1.text = "";
                t2.text = "";
                print("hi");
